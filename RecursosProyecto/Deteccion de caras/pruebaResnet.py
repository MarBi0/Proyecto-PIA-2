...
from keras.layers import Conv2D, MaxPool2D, BatchNormalization, Activation, ZeroPadding2D, MaxPooling2D, Flatten, Dense, \
    Dropout, AveragePooling2D, Add
...
df_image = df[['Image']].copy()

df_sin_imagenes = df.drop('Image', axis=1)

X_train = df_sin_imagenes
y_train = df_image
